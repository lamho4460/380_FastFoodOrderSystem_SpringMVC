...
public class TicketServiceImpl implements TicketService {
    ...
    public long createTicket(String customerName, String subject,
            String body, boolean quantity,float price,List<MultipartFile> attachments) throws IOException {
    ...
    public void updateTicket(long id, String subject,
            String body,boolean quantity,float price, List<MultipartFile> attachments)
       ...
       updatedTicket.setQuantity(quantity);
